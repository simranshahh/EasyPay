...
class FurnitureTabBar extends StatefulWidget {
  const FurnitureTabBar({super.key});

  @override
  State<FurnitureTabBar> createState() => _FurnitureTabBarState();
}

class _FurnitureTabBarState extends State<FurnitureTabBar>
