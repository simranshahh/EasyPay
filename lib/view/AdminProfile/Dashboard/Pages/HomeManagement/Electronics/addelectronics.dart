...
class AddElectronicsData extends StatefulWidget {
  const AddElectronicsData({super.key});

  @override
  State<AddElectronicsData> createState() => _AddElectronicsDataState();
}

class _AddElectronicsDataState extends State<AddElectronicsData> {
                ...
                Container(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          Icon(Icons.text_fields, color: ColorConstant.grey),
                      border: OutlineInputBorder(
