...
class ElectronicsTable extends StatefulWidget {
  const ElectronicsTable({super.key});

  @override
  State<ElectronicsTable> createState() => _ElectronicsTableState();
}

class _ElectronicsTableState extends State<ElectronicsTable> {
