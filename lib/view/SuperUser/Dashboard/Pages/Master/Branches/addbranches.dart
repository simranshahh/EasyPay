...
class AddBranchesData extends StatefulWidget {
  const AddBranchesData({super.key});

  @override
  State<AddBranchesData> createState() => _AddBranchesDataState();
}

class _AddBranchesDataState extends State<AddBranchesData> {
