...
class AddFurnitureData extends StatefulWidget {
  const AddFurnitureData({super.key});

  @override
  State<AddFurnitureData> createState() => _AddFurnitureDataState();
}

class _AddFurnitureDataState extends State<AddFurnitureData> {
